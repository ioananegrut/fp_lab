...
# Format the credentials as required by Streamlit authenticator
...
print(name, username, authentication_status)
...
if authentication_status:
    ...
    st.title("Welcome {}!".format(name))
    st.header("Laborator Fundamentele Programării")
    ...
    student_data = data[data["student_id"]==username]
